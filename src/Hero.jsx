			...
			<div className="relative w-full h-[420px] mb-15" id="home">
				...
				<div className="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
					<div className="ml-1 sm:ml-10 md:ml-36 lg:ml-80 lg-4 md:mb-0 lg:w-1/2">
						...
						<div class="flex flex-col w-full sm:w-auto sm:flex-row ">
							<a href="/books"
							...
							<a href="/register"
								class="flex items-center justify-center w-full px-4 py-4 text-sm font-bold leading-6 capitalize duration-100 transform border-2 rounded-sm cursor-pointer border-blue-300 focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 border-text  hover:shadow-lg hover:-translate-y-1">
								Sign up
							</a>
						</div>
					</div>
