...
function Hero() {
	return (
		<>
			...
			<section className="flex flex-wrap md:m-auto md:w-3/5 mt-5 mb-48 items-center lg:flex-nowrap">
				<img src='/ilustration_reading.jpg' className="md:w-full lg:h-10/12 lg:w-1/2" />
				<div className="md:w-full lg:w-1/2 h-10/12 p-20 flex flex-wrap gap-8">
