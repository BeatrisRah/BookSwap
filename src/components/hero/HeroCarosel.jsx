...
export default function HeroCarousel() {
    ...
    return (
        <div className="w-4/5 mx-auto flex gap-5 mb-80 p-2">
            <div className="relative w-2/3 overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="w-3/5 flex flex-col justify-center bg-gray-50 rounded-lg p-4">
                <div className="w-3/4 p-4 h-2/3 flex flex-col justify-items-center justify-center">
                ...
                <div className="w-3/4 p-4 bg-[#0b89a1] h-25 rounded-2xl inline-flex items-center gap-2">
                    ...
                    <Link className="text-white border-b-2 text-2xl">View Events</Link>
                </div>
            </div>
        </div>
    );
